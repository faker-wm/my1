...
<section id="header-slider" class="owl-carousel" >
	...
	<div class="item"  style="background:url('<%= request.getContextPath()%>/file/${banner[0].banner}');background-repeat:no-repeat;background-size:1341px 490px;">
		<div class="container" >
	...
	<div class="item" style="background:url('<%= request.getContextPath()%>/file/${banner[1].banner}');background-repeat:no-repeat;background-size:1341px 490px;">
		<div class="container">
			<div class="header-content">
	...
	<div class="item" style="background:url('<%= request.getContextPath()%>/file/${banner[2].banner}');background-repeat:no-repeat;background-size:1341px 490px;">
		<div class="container">
	...
	<div class="wrapper">
		<div class="container-fluid">
			<div class="row dis-table">
				<div class="hidden-xs col-sm-6 section-bg about-bg dis-table-cell" style="background:url('<%= request.getContextPath()%>/file/${banner[0].banner}');background-repeat:no-repeat;background-size:570px 440px;">    
